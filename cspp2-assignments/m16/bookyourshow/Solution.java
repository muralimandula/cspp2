		...
		while (input.hasNext()){
			...
			switch (bysmovie[0]) {
				...
				case "book":
				    ...
				    userbooking = moviename+"-"+bysinput[1]+"-"+bysinput[2]+"-"+bysinput[3]+"-"+userseats;
                ...
                case "get":
                    ...
                    System.out.println(addmovieobj.getmovie(moviename, showtime));
                    break;
                ...
                case "print":
                    ...
                    System.out.println(addmovieobj.printbooking(moviename, showbooked, usercontact));
                    break;
